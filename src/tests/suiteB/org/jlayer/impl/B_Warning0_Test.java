...
/**
 * checks the {@code org.jlayer.impl.Unit} class objects generated from {@code faulty.units.Warning0},
 * 
 * @author Gerd Kock
 */
@Test(groups = {"suiteB"})
public class B_Warning0_Test {
	
	// All classes that evoke warnings 
	String unit = userDir + "/src/units/faulty/units/Warning0.java";
    ...
    public void testWarning() {
    	...
    	assertEquals(processedUnit.typeDescr, null);
		assertEquals(processedUnit.fields, null);
		assertEquals(processedUnit.methods, null);
    }
