...
/**
 * checks the {@code org.jlayer.impl.Unit} class objects generated from {@code faulty.units.Warning2}.
 * @author Gerd Kock
 */
@Test(groups = {"suiteB"})
public class B_Warning2_Test {
	
	// All classes that evoke warnings 
	String unit = userDir + "/src/units/faulty/units/Warning2.java";
    ...
    public void testWarning() {
		...
		assertEquals(processedUnit.typeDescr.typeName.toString(), "Warning2<T>");
		assertEquals(processedUnit.fields.size(), 0);
