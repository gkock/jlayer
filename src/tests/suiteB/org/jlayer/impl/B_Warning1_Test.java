...
/**
 * checks the {@code org.jlayer.impl.Unit} class objects generated from {@link faulty.units.Warning1}.
 * @author Gerd Kock
 */
@Test(groups = {"suiteB"})
public class B_Warning1_Test {
	
	// All classes that evoke warnings 
	String unit = userDir + "/src/units/faulty/units/Warning1.java";
    ...
    public void testWarning() {
		...
		assertEquals(processedUnit.typeDescr.typeName.toString(), "Warning1");
