...
/**
 * checks the {@code org.jlayer.impl.Unit} class objects generated from {@code faulty.units.Warning7},
 * 
 * @author Gerd Kock
 */
@Test(groups = {"suiteB"})
public class B_Warning7_Test {
	
	// All classes that evoke warnings 
	String unit = userDir + "/src/units/faulty/units/Warning7.java";
    ...
    public void testWarning() {
		...
		assertEquals(processedUnit.typeDescr.typeName.toString(), "Warning7");
