...
/**
 * checks the {@code org.jlayer.impl.Unit} class object generated from {@link basic.units.UnitModif2}.
 * @author Gerd Kock
 */
@Test(groups = {"suiteB"})
public class B_UnitModif2_Test {
	
	String unit = userDir + "/src/units/basic/units/UnitModif2.java";
	Unit processedUnit;
    ...
    public void testBasics() {
    	...
    	assertEquals(processedUnit.typeDescr.typeName.toString(), "UnitModif2");
    	assertEquals(processedUnit.typeDescr.modifiers.size(), 2);
    	assertTrue(processedUnit.typeDescr.modifiers.contains(Modifier.FINAL));
