...
/**
 * 
 * testing concurrency, basic figures for non void parameterless methods
 * 
 * @author Gerd Kock
 */
@Test(groups = {"suiteC"})
public class C_Concurrency_B_Test {
	...
	public void  intMethod_fork() {
		// TEST OUTPUT
//		System.out.println("TEST OUTPUT intMethod_fork()");
		
		// layer1
		startTime = System.currentTimeMillis();
		layer1.intMethod_fork();
		endTime = System.currentTimeMillis();
		// TEST OUTPUT
//		System.out.println("   layer1.intMethod_fork() took " + (endTime - startTime) + " milliseconds.");
		proc2Units.clear();
		...
		// layer2
		startTime = System.currentTimeMillis();
		layer2.intMethod_fork();
		endTime = System.currentTimeMillis();
		// TEST OUTPUT
//		System.out.println("   layer2.intMethod_fork() took " + (endTime - startTime) + " milliseconds.");
		proc2Units.clear();
		...
		// layer3
		startTime = System.currentTimeMillis();
		layer3.intMethod_fork();
		endTime = System.currentTimeMillis();
		// TEST OUTPUT
//		System.out.println("   layer3.intMethod_fork() took " + (endTime - startTime) + " milliseconds.");
		proc2Units.clear();
	...
	public void  intMethod_sequ() {
		// TEST OUTPUT
//		System.out.println("TEST OUTPUT intMethod_sequ()");
		
		// layer1
		startTime = System.currentTimeMillis();
		layer1.intMethod_sequ();
		endTime = System.currentTimeMillis();
		// TEST OUTPUT
//		System.out.println("   layer1.intMethod_sequ() took " + (endTime - startTime) + " milliseconds.");
		
		// layer2
		startTime = System.currentTimeMillis();
		layer2.intMethod_sequ();
		endTime = System.currentTimeMillis();
		// TEST OUTPUT
//		System.out.println("   layer2.intMethod_sequ() took " + (endTime - startTime) + " milliseconds.");
		
		// layer3
		startTime = System.currentTimeMillis();
		layer3.intMethod_sequ();
		endTime = System.currentTimeMillis();
		// TEST OUTPUT
//		System.out.println("   layer3.intMethod_sequ() took " + (endTime - startTime) + " milliseconds.");
	}
